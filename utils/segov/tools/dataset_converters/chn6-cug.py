...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert CHN6-CUG dataset to mmsegmentation format')
    parser.add_argument('dataset_path', help='CHN6-CUG folder path')
...
def main():
    ...
    if args.out_dir is None:
        out_dir = osp.join('data', 'CHN6-CUG')
    else:
    ...
    image_path = osp.join(dataset_path, 'images')
